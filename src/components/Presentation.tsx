...
const Presentation = () => {
  return (
    <section id='home' className='text-center sm:text-start gap-10 items-center p-5 flex-col sm:flex-row justify-center flex section-title bg-[#F1F0EF] rounded-b-[80px] sm:rounded-b-[150px] dark:bg-[#2B2B2B]'>
      <div>
