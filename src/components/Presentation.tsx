...
const Presentation = () => {
  return (
    <section id='home' className='text-center sm:text-start gap-10 items-center p-5 flex-col sm:flex-row justify-center flex section-title snap-center snap-always'>
      <div>
